...
import expensifyLogo from './assets/work_logo/expensify.png';
import codearenaLogo from './assets/work_logo/codearena.png';
...
export const leetcodeStats = {
  ...
  export const projects = [
    ...
    },
    {
      ...
      title: "CodeArena",
      description:
        "A competitive programming platform where users can compete with each other in real-time coding challenges. The platform features a modern UI with a code editor, test cases, and a leaderboard to track progress.",
      image: codearenaLogo,
      tags: ["HTML", "CSS", "JavaScript", "React JS","Redux","Node JS", "MongoDB", "Express", "Tailwind CSS","Websocket","JWT","Socket.io"],
      github: "https://github.com/Harsh-shuklaa/CodeArena",
      webapp: "https://codearena-vg70.onrender.com/", 
    },
    {
      id: 2,
      title: "Expensify",
      description:
        "Expensify is a complete expense management system built with React JS and Redux. It allows users to track their daily expenses, categorize them, and view detailed reports. The application features a modern UI, real-time updates, and an intuitive interface for managing personal finances.",
      image: expensifyLogo,
      tags: ["HTML", "CSS", "JavaScript", "React JS","Redux","Context API"],
      github: "https://github.com/Harsh-shuklaa/expensify", 
      webapp: "https://expensifyapp-h3qt.onrender.com/",
    },
    // {
    //   id: 3,
